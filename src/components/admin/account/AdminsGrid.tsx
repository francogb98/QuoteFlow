...
import { getAdmins } from "@/actions/admin/account/getAdmins";
  ...
  return (
    <div className="space-y-4 flex flex-col-reverse gap-3 bg-white p-2">
      <section className="space-y-4">
        ...
        <DataTable
          data={admins.filter((admin: Admin) => admin.rol !== "ADMINISTRADOR")}
          ...
          renderItem={(admin) => (
            <AdminCard
              key={admin.id}
              admin={admin as unknown as React.ComponentProps<typeof AdminCard>["admin"]}
