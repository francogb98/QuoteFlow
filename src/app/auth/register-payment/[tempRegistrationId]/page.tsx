      ...
      <div className="w-full max-w-2xl mx-auto py-8">
        <Card className="bg-white/80 backdrop-blur-md shadow-2xl rounded-2xl p-6 md:p-8 border border-purple-100">
          ...
          <CardContent className="space-y-6">
            ...
            {/* Botón para volver al formulario con campos precargados */}
            <div className="mt-4">
              <Link
                href={`/auth/new-account?tempId=${tempRegistrationId}`}
                className="inline-block"
              >
                <span className="inline-flex items-center px-3 py-2 border border-purple-200 bg-white text-purple-700 rounded-md shadow-sm hover:bg-purple-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-200 transition text-sm">
                  Editar datos
                </span>
              </Link>
            </div>
