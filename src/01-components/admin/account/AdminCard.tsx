...
import { deleteAdmin } from "@/01-actions/admin/account/deleteAdmin";
...
export const AdminCard = ({
  ...
  const { showSuccess, showError } = useNotifications(); // Usar el hook de notificaciones
    ...
    <div className="border border-purple-400 p-4 rounded flex flex-col justify-between">
      <div className="space-y-1">
        ...
        <p className="text-sm text-gray-600">
          ...
          {/* achica el tamaño del texto segun la pantala */}
