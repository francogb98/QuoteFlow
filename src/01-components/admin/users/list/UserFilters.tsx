...
import { Calendar, Filter, Users, CalendarDays, X, Info } from "lucide-react";
    ...
    <div className="bg-white rounded-2xl shadow-lg border border-purple-100 overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-purple-50 to-emerald-50 p-4 sm:p-6 border-b border-purple-100">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <>
                  ...
                  <span className="truncate">
                    <span className="hidden sm:inline">
                      {isDynamicTariff ? "Vencimientos en " : "Usuarios de "}
                    </span>
          ...
          >
            ...
            >
              <span className="hidden sm:inline">
                {filterByMonth ? "Filtro activo" : "Filtrar por período"}
              </span>
      ...
      {filterByMonth && (
        <div className="p-4 sm:p-6 bg-gradient-to-r from-purple-50/50 to-emerald-50/50 border-b border-purple-100">
          ...
          {/* Información adicional para sistema dinámico */}
          {isDynamicTariff && (
            <div className="mb-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
              <div className="flex items-start gap-2">
                ...
                <div className="text-xs text-blue-800">
                  ...
                  <p>
                    Se mostrarán usuarios con pagos que vencen en el período
                    seleccionado, basado en sus fechas específicas de
                    vencimiento.
                  </p>
                </div>
              </div>
