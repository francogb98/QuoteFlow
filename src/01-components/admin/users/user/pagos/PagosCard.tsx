...
export const PagosCard = ({
  ...
  // Calcular si está vencido en sistema dinámico
  const isOverdue =
    isDynamicTariff && pago.fechaVencimiento && pago.estado !== "PAGADO"
      ? new Date() > new Date(pago.fechaVencimiento)
      : pago.estado === "VENCIDO";
  ...
  return (
    ...
    >
      {/* Decoración de fondo */}
      <div
        className={`absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-${actualStatusConfig.color}-100/50 to-${actualStatusConfig.color}-200/50 rounded-full -translate-y-10 translate-x-10`}
      ></div>

      <div className="relative">
        {/* Header con monto y período */}
          ...
          <div className="flex items-center">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">
                {isDynamicTariff && pago.fechaVencimiento
                  ? `Vence: ${new Date(
