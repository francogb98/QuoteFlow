...
export const ModalCreatePayment = ({
  ...
  // Actualizar monto por defecto cuando cambia la configuración
  useEffect(() => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (isDynamicTariff) {
      if (!formData.fechaVencimiento) {
        toast.error(
          "La fecha de vencimiento es requerida para el sistema dinámico"
        );
        return;
      }
    } else {
      ...
      <div className="flex min-h-full items-center justify-center p-4">
        <div className="relative w-full max-w-md transform overflow-hidden rounded-2xl bg-white shadow-2xl transition-all animate-in zoom-in-95 duration-300">
            ...
            <div className="flex items-center">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600">
                  {isDynamicTariff
                    ? "Sistema dinámico por fecha"
                    : "Sistema fijo mensual"}
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="bg-blue-50 border-b border-blue-200 p-4">
              <div className="flex items-start gap-3">
                ...
                <div className="text-sm text-blue-800">
                  ...
                  <p>
                    Especifica la fecha de vencimiento exacta para este pago.
                  </p>
                </div>
              </div>
            </div>
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            {/* Período o Fecha de Vencimiento */}
            {isDynamicTariff ? (
              <div>
              ...
              <label className="block text-sm font-medium text-gray-700 mb-2">
                ...
                {isDynamicTariff && (
                  <span className="text-xs text-blue-600 ml-2">
                    (Sugerido: ${configuracionTarifa?.montoBase})
                  </span>
                )}
              </label>
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-xs text-amber-700">
                    {isDynamicTariff
                      ? "No se puede crear más de un pago por mes para el mismo usuario. Verifica que no exista ya un pago para el período seleccionado."
                      : `No se puede crear más de un pago por mes para el mismo usuario. Verifica que no exista ya un pago para ${
                          meses[formData.mes! - 1]
                        } ${formData.año}.`}
                  </p>
                </div>
              </div>
